    ...
    "hello": {
        "[hi]": {
            "have you seen a good movie recently": {
                "[yes]": {"cool what is it": {"error": "root"}},
                "[no]": {"ok then": {"error": "root"}},
            },
            "how are you": {
                "[good]": {"thats good": {"error": "root"}},
                "[bad]": {"sorry to hear that": {"error": "root"}},
            },
        },
        "[how, you]": {"good": {"error": "root"}},
    },
}
...
df.add_state(
    "recovery_question",
    global_nlu="[!{do, who, what, when, where, why, how, is, can, should}, /.*/]",
)
